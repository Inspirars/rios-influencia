  ...
  return (
    <div className="bg-[#FFF0F5] grid grid-cols-1 md:grid-cols-2 py-10 md:py-14 lg:py-20 px-5 lg:px-[111px] gap-3 lg:gap-6">
        <div className="bg-white rounded-2xl lg:rounded-[20px] px-5 md:px-12 lg:px-14 pt-8 pb-10 md:pt-10 md:pb-12 lg:pt-14 lg:pb-16 flex flex-col items-center font-satoshi">
            ...
            <p className="text-center text-grey-500 text-sm lg:text-base lg:max-w-[90%]">
            To end revolving door patient care by championing patient-centered, holistic healthcare and ensuring seamless transitions from hospital to home.
            </p>
        </div>
        <div className="bg-white rounded-2xl lg:rounded-[20px] px-5 md:px-12 lg:px-14 pt-8 pb-10 md:pt-10 md:pb-12 lg:pt-14 lg:pb-16 flex flex-col items-center font-satoshi">
            <header className="text-[#000] text-2xl lg:text-[32px]">
            ...
            <p className="text-center text-grey-500 text-sm lg:text-base lg:max-w-[90%]">
            To be the vital link between hospital and home, creating a global platform for leading consulting, training, and education in pharmaceutical care.
            </p>
        </div>
        ...
        <div className="bg-white rounded-2xl lg:rounded-[20px] px-5 md:pl-10 lg:pl-20 pt-8 pb-10 md:pt-10 md:pb-12 lg:pt-14 lg:pb-14 flex flex-col items-start font-satoshi">
            ...
            <p className=" text-grey-500 text-sm lg:text-lg pb-8 md:pb-9 lg:pb-8 lg:max-w-[90%] text-justify">
            Temitope Odetunde is a visionary leader with a deep commitment to enhancing patient care. Her journey from a community health service professional to the founder of Rios-Influencia is a testament to her dedication, empathy, and drive for innovation in healthcare. Her firsthand experiences have shaped the mission and values of Rios Influencia, guiding the company towards making a global impact.
            </p>
